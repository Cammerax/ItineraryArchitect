                ...
                return (
                  <Link key={it.id} href={`/itineraries/${it.slug}`}>
                    <Card className="overflow-hidden hover:shadow-lg transition-all h-full group cursor-pointer">
                      <div className="h-40 bg-gradient-to-br from-sage-100 to-stone-200 flex items-center justify-center relative">
                        <Globe2 className="h-12 w-12 text-sage-300" />
                      ...
                      <CardContent className="p-4">
                        ...
                        <h3 className="font-bold text-stone-900 mb-2 group-hover:text-sage-700 transition-colors text-sm leading-tight">
                          {it.title}
                        </h3>
                        ...
                        {highlights.slice(0, 2).map((h, i) => (
                          <div key={i} className="flex items-center gap-1 text-xs text-stone-600 mb-1">
                            <Star className="h-3 w-3 text-sage-400 flex-shrink-0" />
                        ...
                        <div className="flex items-center justify-between mt-3 pt-3 border-t border-stone-100">
                          ...
                          <span className="font-bold text-sage-700">{formatPrice(it.price)}</span>
                        </div>
                      </CardContent>
                    </Card>
                  </Link>
