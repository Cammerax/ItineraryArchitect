      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <h3 className="text-white text-xl font-bold mb-3">The Itinerary Architect</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/explore" className="hover:text-amber-400 transition-colors flex items-center gap-1.5"><Map className="h-3.5 w-3.5" />Interactive Map</Link></li>
              <li><Link href="/itineraries" className="hover:text-amber-400 transition-colors flex items-center gap-1.5"><BookOpen className="h-3.5 w-3.5" />All Itineraries</Link></li>
              <li><Link href="/flights" className="hover:text-amber-400 transition-colors flex items-center gap-1.5"><Plane className="h-3.5 w-3.5" />Flight Finder</Link></li>
              <li><Link href="/request" className="hover:text-amber-400 transition-colors flex items-center gap-1.5"><MessageSquare className="h-3.5 w-3.5" />Custom Trip</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/dashboard" className="hover:text-amber-400 transition-colors">My Itineraries</Link></li>
            </ul>
          </div>
        </div>
