          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              <div
                ...
                className={`w-8 h-4 rounded-full transition-colors ${includeRedEye ? "bg-amber-500" : "bg-stone-300"} relative`}
              >
              ...
              {(["all", "day-before", "red-eye"] as const).map((type) => (
                <button
                  ...
                  className={`text-xs px-3 py-1.5 rounded-full border transition-colors ${
                    activeType === type ? "bg-amber-600 text-white border-amber-600" : "text-stone-600 border-stone-300 hover:border-amber-400"
                  }`}
                >
            ...
            {results.nearestAirports.map((ap) => (
              <div key={ap.code} className="bg-white rounded-lg border border-stone-200 p-3 flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center flex-shrink-0">
                  <span className="text-xs font-bold text-amber-700">{ap.code}</span>
                </div>
                <div>
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-4">
                      <div className="text-center w-20">
                        ...
                        <p className="text-xs font-medium text-amber-700">{flight.originAirport.code}</p>
                      </div>
                      ...
                      <div className="text-center w-20">
                        ...
                        <p className="text-xs font-medium text-amber-700">{results.destAirport.code}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-bold text-amber-700">{formatPrice(flight.price)}</p>
